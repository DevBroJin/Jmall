   ...
   <div class="text-center">
    <div class="box box-primary">
      ...
      <div class="form-group row">
        <label for="mbsp_email" class="col-2">이메일 입력</label>
        <div class="col-8">
        ...
        <div class="col-2">
          ...
          <div class="form-group row">
           <label for="mbsp_id" class="col-2">새 비밀번호</label>
          <div class="col-10">
            <input type="text" class="form-control" name="mbsp_id" id="mbsp_id" placeholder="비밀번호 입력...">
          </div>
        </div>
        <div class="form-group row">
          <label for="mbsp_password" class="col-2">비밀번호 확인</label>
          <div class="col-10">
            <input type="password" class="form-control" name="mbsp_password" id="mbsp_password" placeholder="비밀번호 확인...">
          </div>
        </div>
      </div>
