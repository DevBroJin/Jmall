...
<body class="d-flex flex-column h-100">
							...
							<div class="box-footer clearfix">
								<div class="row">
										...
										<nav aria-label="...">
											<ul class="pagination">
												...
												<c:if test="${pageMaker.prev }">
													<li class="page-item">
														<a href="/board/list?pageNum=${pageMaker.startPage - 1 }"
									...
									<div class="col-6">
										...
										<!--1)페이지번호 [이전] 1  2  3  4  5  [다음] 페이지  클릭할 때 사용 action="/board/list"-->
	...
	<%@include file="/WEB-INF/views/comm/plugIn.jsp" %>
		<script>
			...
			//<a class="mopage">1</a><a class="mopage">2</a><a class="mopage">3</a><a class="mopage">4</a>
			...
			// <a class="move">제목</a>
				...
				Array.from(moves).forEach(function (move) {
					...
					move.addEventListener("click", function(event) {
						...
						//bno 제거작업
						// 목록에서 제목 클릭후 게시물읽기에서 뒤로버튼에 의하여 목록으로 돌아오고
