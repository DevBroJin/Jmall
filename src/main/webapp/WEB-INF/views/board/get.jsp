						...
						<div class="box box-primary">
							...
							<div class="box-body">
								<div class="form-group">
									<label for="title">Bno</label> <input type="text" class="form-control" name="title"
										id="title" value="${board.bno }" readonly>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label for="writer">Writer</label> <input type="text" class="form-control"
										name="writer" id="writer" value="${board.writer}" readonly>
								</div>
								<div class="form-group">
									<label>Content</label>
								...
								<div class="form-group">
									<label for="updateddate">updateddate</label> <input type="text" class="form-control"
